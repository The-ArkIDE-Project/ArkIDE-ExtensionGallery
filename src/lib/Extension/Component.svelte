<script>
    ...
    const baseUrl = "https://studio.arkide.site/editor.html?extension=";
...
<div class="block">
    ...
    <div>
        ...
        {#if example}
            <p>
                <a href={`https://studio.arkide.site/editor.html?project_url=${encodeURIComponent(`${$page.url.origin}/examples/projects/${example}`)}`}>
                    Example Project
                </a>
            </p>
        {/if}
